...
class VODTitle(BaseModel):
    ...
    csfd_id: Optional[int] = Field(None, description="Own ČSFD id (from URL)")
    root_id: Optional[int] = Field(None, description="Top-level serial id (== csfd_id for works)")
    season_no: Optional[int] = Field(None, description="Season number")
    episode_no: Optional[int] = Field(None, description="Episode number")
    season_total: Optional[int] = Field(None, description="Total seasons the serial has (from page header)")
    episode_total: Optional[int] = Field(None, description="Total episodes the serial has (from page header)")
